import { useEffect, useState } from 'react'; import { productsApi, ordersApi, customersApi } from '../services/api'; import { Package, ShoppingBag, Users, AlertTriangle } from 'lucide-react'; import { PieChart, Pie, Cell, ResponsiveContainer, Tooltip } from 'recharts';
...
export default function Dashboard() {
  ...
  const cards = [{label:'Productos',value:stats.products,icon:Package,color:'bg-indigo-500'},{label:'Pedidos',value:stats.orders,icon:ShoppingBag,color:'bg-emerald-500'},{label:'Clientes',value:stats.customers,icon:Users,color:'bg-amber-500'},{label:'Stock Bajo',value:stats.lowStock,icon:AlertTriangle,color:'bg-red-500'}];
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800">
          <h2 className="font-semibold text-gray-900 dark:text-white mb-4">Pedidos por Estado</h2>
